...
public interface UserRepository extends JpaRepository<UserEntity, Long> , UserRepositoryCustom {
    ...
    List<UserEntity> findByStatusAndRoles_CodeAndBuildings_Id(Integer status, String roleCodes, Long id);
    List<UserEntity> findByStatusAndRoles_CodeAndCustomers_Id(Integer status, String roleCodes, Long id);
}
